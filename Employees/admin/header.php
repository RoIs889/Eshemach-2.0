...
<body class="grey lighten-2">
    <main>
        ...
        <header>
            <nav class="nav-extended transparentBG">
                <div class="nav-wrapper">
                    <a href="admin.php" class="brand-logo left"><img class="responsive-img" style="width: 200px;" src="../../assets/images/E-Shemach-logo-white (2).png" /></a>
                ...
                <div class="nav-content">
                    ...
                    <ul class="tabs tabs-transparent">
                        <li class="tab"><a href="#Cust">Customers Tab</a></li>
                        <li class="tab"><a href="#Emp">Employees Tab</a></li>
