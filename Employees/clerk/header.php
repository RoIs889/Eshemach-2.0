        ...
        <header>
            <nav class="transparentBG">
                <div class="nav-wrapper">
                    <a href="clerk.php" class="brand-logo"><img class="responsive-img" style="width: 200px;" src="../../assets/images/E-Shemach-logo-white (2).png" /></a>
                    <a href="#" class="sidenav-trigger" data-target="mobile-nav">
                        <i class="material-icons">menu</i>
                    </a>

                    <ul class="right hide-on-med-and-down left">
                        <li><a href="purchasing.php"><span class="fa-solid fa-circle-info"></span> sell</a></li>
                        <li><a href="viewhisofcust.php"><span class="fa-solid fa-envelope"></span>Customer History</a></li>
