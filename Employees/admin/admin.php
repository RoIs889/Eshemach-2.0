...
<ul class="collapsible popout" id="Other">
    ...
    <li>
        ...
        <div class="collapsible-body">
                                        ...
                                        <table id="Table" class="highlight centered responsive-table">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo '<td><input value="' . $row["Quantity"] . '" id="' . $row["ID"] . '_quan" name="' . $row['ID'] . '_quan" type="number"  step="0.01" min="0"></td>';
                                                    echo '<td><input value="' . $row["Price"] . '" id="' . $row["ID"] . '_price" name="' . $row['ID'] . '_price" type="number"  step="0.01" min="0"></td>';
            ...
            <div class="col s12" id="addnew2">
                <div class="card grey lighten-3" style="padding: 5px 0px 0px 5px; border: 1px solid #EEE;">
                    <!-- <div class="z-depth-1 grey lighten-4 row" style="display: block; padding: 2px 5px 0px 5px; border: 1px solid #EEE;"> -->
                    <div class="card-content">
                        <h5 class="card-title center-align">Add new Product</h5>
                        <form action="admin.php" method="post" class="add-form" id="form" autocomplete="off">
                            <div class="red-text center-align"><?php echo $errors2['invalid']; ?></div>
                            <!-- <h6 class="center-align blue-text">Make sure to fill all necessary fields!</h6> -->
                            <div class="row">
                                <div class="input-field col s12 m3">
                                    <!-- <i class="material-icons prefix">email</i> -->
                                    <span class="material-symbols-outlined prefix">list</span>
                                    ...
                                    <label for="quan">Type</label>
                                    <div class="red-text right-align"><?php echo $errors2['type']; ?></div>
                                </div>
                                <div class="input-field col s12 m3">
                                    <!-- <i class="material-icons prefix">email</i> -->
                                    <span class="material-symbols-outlined prefix">inventory</span>
                                    <input name="name1" type="text" id="name1" value="<?php echo htmlspecialchars($title3) ?>" />
                                    <label for="name1">Product name</label>
                                    <div class="red-text right-align"><?php echo $errors2['name']; ?></div>
                                </div>
                                <div class="input-field col s12 m2">
                                    <!-- <i class="material-icons prefix">email</i> -->
                                    <span class="material-symbols-outlined prefix">tag</span>
                                    <input name="quan" type="number"  step="0.01" min="0" id="quan" value="<?php echo htmlspecialchars($quan) ?>" />
                                    <label for="quan">Quantity</label>
                                    <div class="red-text right-align"><?php echo $errors2['quan']; ?></div>
                                </div>
                                <div class="input-field col s12 m2">
                                    <!-- <i class="material-icons prefix">email</i> -->
                                    <span class="material-symbols-outlined prefix">payments</span>
                                    <input name="price" type="number"  step="0.01" min="0" id="price" value="<?php echo htmlspecialchars($price) ?>" />
                                    <label for="price">Price</label>
                                    <div class="red-text right-align"><?php echo $errors2['price']; ?></div>
                                </div>
                                <div class="input-field col s12 m2">
                                    <!-- <i class="material-icons prefix">email</i> -->
                                    <span class="material-symbols-outlined prefix">tag</span>
                                    <input name="stk" type="text" id="stk" value="<?php echo htmlspecialchars($stk) ?>" />
                                    <label for="stk">Available Stock</label>
                                    <div class="red-text right-align"><?php echo $errors2['stk']; ?></div>
                                </div>
                            </div>
                            <div class="row">
                                <!-- <button class="btn blue darken-2 waves-effect waves" onclick="prev_1()" id="prev_2">Previous
                                ...
                                <button class=" right btn green darken-2 waves-effect waves" type="submit" name="add">Add
                                    <i class="material-symbols-outlined"></i>
                                </button>
                            </div>
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <div id="editableTable" class="section">
                            <form class="formValidate" id="formValidate1" method="post" action="" novalidate="novalidate">
                                <div class="row">
                                    <div class="col s12 m4 l3">
                                        <h5 class="header center">Summary of Purchases</h5>
                                        <hr width="50%">
                                    </div>
                                    <div>
                                        <table id="Table" class="highlight centered responsive-table">
                                            <thead>
                                                <tr>
                                                    <th data-field="price">Total Unit Sugar Sold</th>
                                                    <th data-field="price">Total Unit Oil Sold</th>
                                                    <th data-field="price">Total Unit Flour Sold</th>
                                                    <th data-field="price">Other Goods Sold</th>
                                                    <!-- <th data-field="name">Product Name</th>
                                                    <th data-field="price">Price</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $conn = new mysqli("localhost", "root", "", "my_db");
                                                $query = "SELECT `Quantity` FROM `purchase` WHERE `Type` = 'Sugar' ";
                                                $query2 = "SELECT `Quantity` FROM `purchase` WHERE `Type` = 'Oil' ";
                                                $query3 = "SELECT `Quantity` FROM `purchase` WHERE `Type` = 'Flour' ";
                                                $query4 = "SELECT `Quantity` FROM `purchase` WHERE `Type` = 'Other' ";
                                                ...
                                                while ($column2 =  mysqli_fetch_assoc($result2)) {
                                                    $total2 += $column2['Quantity'];
                                                }
                                                while ($column3 =  mysqli_fetch_assoc($result3)) {
                                                    $total3 += $column3['Quantity'];
                                                }
                                                while ($column4 =  mysqli_fetch_assoc($result4)) {
                                                    $total4 += $column4['Quantity'];
                                                }
                                                echo '<tr><td>' . $total . '</td>';
                                                echo '<td>' . $total2 . '</td>';
                                                echo '<td>' . $total3 . '</td>';
                                                echo '<td>' . $total4 . '</td></tr>';
                                                ?>
                                        ...
                                        <table id="Table" class="highlight centered responsive-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name">Product Name</th>
                                                    <th data-field="price">Price</th>
                                                    <th data-field="price">Quantity(Unit)</th>
                                                    <th data-field="name">Customer</th>
                                                    <th data-field="name">Clerk</th>
                                                    <th data-field="name">Date of Purchase</th>
                                                </tr>
                                ...
                                <div>
                                    <table id="Table" class="highlight centered responsive-table">
                                        <thead>
                                            <tr>
                                                <th data-field="name">ID</th>
                                                <th data-field="name">Name of Employee</th>
